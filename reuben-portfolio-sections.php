        ...
        if (function_exists('acf_add_local_field_group')) {
            acf_add_local_field_group(array(
                ...
                'fields' => array(
                    ...
                    array(
                        'key' => 'field_photo_gallery_v2',
                        'label' => 'Photo Gallery',
                        'name' => 'photo_gallery',
                        'type' => 'gallery',
                        'instructions' => 'Select multiple images for photograph stories (used in carousel display). Click "Add to gallery" to select images from Media Library.',
                        'required' => 0,
                        'return_format' => 'array',
                        'preview_size' => 'medium',
                        'library' => 'all',
